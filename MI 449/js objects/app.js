  // Initialize Firebase
var config = {
  apiKey: 'AIzaSyD5TJ93_fyRZKAm1-q6lKCoxYEgIrDrOyU',
  authDomain: 'joke-a-tron-9000-6293a.firebaseapp.com',
  databaseURL: 'https://joke-a-tron-9000-6293a.firebaseio.com',
  projectId: 'joke-a-tron-9000-6293a',
  storageBucket: 'joke-a-tron-9000-6293a.appspot.com',
  messagingSenderId: '818520119119'
}
firebase.initializeApp(config)
firebase.auth().signInAnonymously()

firebase.database().ref('jokes').child('gummy bear').set({
